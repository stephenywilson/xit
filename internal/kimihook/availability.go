...
// always keyed off the USER home, never any project-local directory — so
// the probe must look in the same place `cmdAuto`'s versionGate does,
// regardless of which project's hook invoked it.
