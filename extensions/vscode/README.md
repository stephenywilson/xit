...
| `吸T神功 · 最近 Claude · 准备就绪` | 空闲 — 最近有 Claude 的 XiT 适配器事件 |
...
**诚实检测说明：** 吸T神功**不会读取** Claude、Codex、Gemini、Cursor 的聊天内容，也不会读取私有 webview 内部状态。如果 VS Code 没有暴露当前 AI 面板信息，状态栏只显示“最近 Claude/Codex”或“准备就绪”，**不会假装已连接**。
